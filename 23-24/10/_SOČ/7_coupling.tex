...
\begin{figure}[H]
    \includegraphics[width=1\textwidth]{state_graph_overview_d_k.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=0.49\textwidth]{stable_modes_overview.png}
    \includegraphics[width=0.49\textwidth]{state_deviation_overview.png}
    \centering
