...
\begin{wrapfigure}{r}{0.5\textwidth}
    \includegraphics[width=0.45\textwidth]{imgs/dims.png}
    \centering
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \includegraphics[width=0.45\textwidth]{imgs/mom_inert_setup.png}
    \centering
...
\begin{wrapfigure}{r}{1\textwidth}
    \includegraphics[width=1\textwidth]{imgs/spin_pendulum_field_rec.png}
    \centering
...
Dalším dosazením do předchozí rovnice \ref{eq:mom_inert} získáváme výslednou hodnotu:
\begin{equation}
...
\begin{wrapfigure}{r}{1\textwidth}
    \includegraphics[width=1\textwidth]{imgs/mag_field_measurement_2mag_10cm.png}
    \centering
    \caption[Nasnímaný průběh magnetické indukce v čase pro měření remanence]{Nasnímaný průběh magnetické indukce v čase pro měření remanence (modře). Průměrné hodnoty horní orientace (zeleně čerchovaně) a dolní orientace (modře čerchovaně). Odpovídající odchylky jsou znázorněny tečkovaně. Výsledná hodnota magnetické indukce tohoto příkladu, tedy dvou magnetů ve vzálenosti 10 cm je: $B = 1.01(8) \cdot 10^{-5} T$}
