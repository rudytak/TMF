...
\begin{wrapfigure}{r}{0.5\textwidth}
    \includegraphics[width=0.45\textwidth]{imgs/B_field_in_distance.png}
    \centering
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \includegraphics[width=0.45\textwidth]{imgs/F_in_distance.png}
    \centering
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \includegraphics[width=0.5\textwidth]{imgs/Final_remanence.png}
    \centering
