...
Celkem provedeme tedy měření 2 magnetů, 3 magnetů a velkého magnetu pro vzdálenosti $5cm$, $10cm$, $20cm$ a $30cm$.
...
Z rozdílu průměrných hodnot magnetického pole v obou otočeních magnetů určíme velikost magnetického pole generovaného pouze magnetem (očištěného od pozadí). Z odchylek také určíme celkovou odchylku výsledné hodnoty.
...
\begin{wrapfigure}{r}{1\textwidth}
    \includegraphics[width=1\textwidth]{imgs/meag_field_emasurement_2mag_10cm.png}
    \centering
    \caption[Nasnímaný průběh magnetické indukce v čase pro spinnerové kyvadlo]{Nasnímaný průběh magnetické indukce v čase (modře) pro spinnerové kyvadlo. Peaky, označující uplynutí jedné půlperiody, jsou vyznačeny červeně.}
