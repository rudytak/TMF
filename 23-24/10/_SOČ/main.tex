...
\lstinputlisting[language=Python]{./prilohy/snippets/c1.py}
\begin{lstlisting}[language=Python, caption=Kód k analyzování spinenrového kyvadla]
\end{lstlisting}
\label{code:1}
...
Toto je poměrně čitelný a přívětivý formát ukládání dat, která v \texttt{Pythonovém} skriptu načteme pomocí funkce \texttt{open()}.
