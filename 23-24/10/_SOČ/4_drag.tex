...
Po analýze všech naměřených dat výše uvedeným algoritmem (celkem 7 měření) a provedení fitu funkcí dle rovnice \ref{eq:drag_res_wlin} získáváme koeficienty v následujících rozmezích:
\begin{equation}
