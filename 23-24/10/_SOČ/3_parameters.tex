...
Očekávali bychom, že se $B_r$ v závislosti na vzdálenosti nebude měnit, a pro každé měření určíme souhrnnou hodnotu pomocí optimalizace fitu konstantní funkcí. Výsledkem všech měření bude aritmetický průměr těchto souhrnných hodnot.
